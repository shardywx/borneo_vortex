#!/usr/bin/python
# https://github.com/kurkutesa/Atmopsheric_Physics_class_codes/blob/
# fa6d4cedb0a08b1f4234b5c9dd7d5c3d066f3d36/weather_modules.py
...
def gradient_cartesian(f, *varargs):
    ...
    if n==1:
       ...
       if nzz>1:
               ...
               if zin[1] < zin[0]:
                   dz = dz*-1 
                # assume the model top is the first index and the lowest model is the last index
